...
function search_payment(page){
	$('#student_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#student_div').load("search_payment.php",{'id_name':$('#id_name').val(),'page':page});
}
            ...
            <tr>
              <td align="center" class="rounded-corners"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align="center">&nbsp;</td>
                  <td align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_payment('0');"/></td>
                </tr>
              </table></td>
            </tr>
          </table>
