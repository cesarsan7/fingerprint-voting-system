...
<tr class="body_text">
  ...
  <td width="300" align="center" class="border_bottom_left_right"><input name="subj_<?php echo $num; ?>" type="text" class="body_text" id="subj_<?php echo $num; ?>" size="50" /><input type="hidden" name="subj_id_<?php echo $num; ?>" id="subj_id_<?php echo $num; ?>" /></td>
