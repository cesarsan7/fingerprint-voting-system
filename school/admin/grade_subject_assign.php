...
function subject(subj_name,subj_id){
   $("#"+subj_name).autocomplete("sub_load.php", {
		width: 225,
		matchContains: true,
		selectFirst: false
	});
	$("#"+subj_name).result(function(event, data, formatted) {
...
function gen_subject(div_id,num){
	$('#'+div_id).load("gen_grade_subject.php",{'num':num});
}
            ...
            <tr>
              <td height="25" colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="body_text">
                  ...
                  <td width="300" align="center" class="border_bottom_left_right"><input name="subj_1" type="text" class="body_text" id="subj_1" size="50"  onfocus="subject('subj_1','subj_id_1')"/>
                    <input type="hidden" name="subj_id_1" id="subj_id_1" /></td>
