...
function search_users(page){
	$('#user_div').html('<p><img src="../images/loading.gif"/></p>');
	$('#user_div').load("search_users.php",{'name':$('#name').val(),'u_type':$('#u_type').val(),'page':page});
}

function delete_user(u_id){
	if(confirm("Do you want to delete this user?")){
		window.location='delete_user.php?u_id='+u_id;
	}
}
</script>
<!-- InstanceEndEditable -->
...
<li><a href="../logout.php">LOGOUT</a></li>
        ...
        <table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" colspan="3" align="left" class="page_title_text">SEARCH USERS</td>
              </tr>
            <tr>
            ...
            <tr>
              ...
              <td align="center">&nbsp;</td>
              <td align="left"><input type="image" src="../images/search.gif" name="search" id="search" value="Submit" onclick="search_users('0');"/></td>
            </tr>
          </table>
          </td>
          </tr>
                  ...
                  <br />
            <div class="red_text" id="helpdiv" align="center"></div>
			<div id="user_div" align="center"></div>
