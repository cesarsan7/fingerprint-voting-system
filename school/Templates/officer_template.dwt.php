        ...
        <td width="810" align="center"><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><ul id="MenuBar1" class="MenuBarHorizontal">
              <li><a href="../officer/index.php">HOME</a></li>
<li><a href="#" class="MenuBarItemSubmenu">VOTER</a>
  <ul>
                  <li><a href="../officer/student.php">ADD</a></li>
                  <li><a href="../officer/view_student.php">VIEW</a></li>
                  </ul>
              </li>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="left"><!-- TemplateBeginEditable name="Editable_Body" -->Editable_Body<!-- TemplateEndEditable --></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
