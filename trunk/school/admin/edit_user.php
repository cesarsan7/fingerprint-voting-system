...
if($user_type == "admin"){
	$query_user="SELECT * FROM tbl_user WHERE u_id='".$_GET['u_id']."'";
...
function check_username(u_id){
	$('#uname_div').load("check_username.php",{'uname':$('#uname').val(),'u_id':u_id});
}
</script>
<!-- InstanceEndEditable -->
</head>
...
<li><a href="../logout.php">LOGOUT</a></li>
	...
	<form action="update_user.php" method="post" name="user_form" id="user_form" onsubmit="return user_validation();">
    <input name="u_id" id="u_id" type="hidden" value="<?php echo $_GET['u_id']; ?>" />
        <table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr class="body_text">
              ...
              <td width="255" align="left"><input name="name" type="text" class="body_text" id="name" size="40" value="<?php echo $row_user["u_name"]; ?>"/></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">NIC</td>
              <td align="center">:</td>
              <td align="left"><input name="nic" type="text" class="body_text" id="nic" size="25" value="<?php echo $row_user["u_nic"]; ?>"/></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left" valign="top">Address</td>
              <td align="center" valign="top">:</td>
              <td align="left"><textarea name="address" cols="30" rows="3" class="body_text" id="address"><?php echo $row_user["u_address"]; ?></textarea></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">Telephone No</td>
              <td align="center">:</td>
              <td align="left"><input name="tel" type="text" class="body_text" id="tel" size="25" value="<?php echo $row_user["u_tel"]; ?>"/></td>
            </tr>
            <tr class="body_text">
              <td height="25" align="left">Date</td>
              <td align="center">:</td>
              <td align="left"><input name="date" type="text" class="body_text" id="date" size="40" value="<?php echo $row_user["date"]; ?>"/></td>
            </tr>
            <tr class="body_text">
              ...
              <option value="admin" <?php if($row_user["u_type"] == "admin"){echo "selected";}?>>Admin</option>
              <option value="teacher" <?php if($row_user["u_type"] == "officer"){echo "selected";}?>>Officer</option>
              </select>
              </td>
            </tr>
            <tr class="body_text">
              <td height="25" colspan="3" align="left"><table width="400" border="0" cellspacing="0" cellpadding="0">
                <tr class="body_text">
                  ...
                  <td width="20" align="center">:</td>
                  <td width="255" align="left"><input name="uname" type="text" class="body_text" id="uname" size="25" onkeyup="check_username('<?php echo $_GET['u_id']; ?>');" value="<?php echo $row_user["u_uname"]; ?>"/></td>
                </tr>
              </table>
              <div id="uname_div" class="red_text" align="center"><?php if(isset($_SESSION['user_error_mes'])){echo $_SESSION['user_error_mes'];}?></div>
              </td>
              </tr>
            <tr class="body_text">
              ...
              <td align="center">:</td>
              <td align="left">
              <input name="old_pwd" id="old_pwd" type="hidden" value="<?php echo $row_user["u_pwd"]; ?>" />
              <input name="pwd" type="password" class="body_text" id="pwd" size="25" /></td>
            </tr>
            <tr class="body_text">
